...
function Button({
  ...
  return (
    <ButtonPrimitive
      data-slot="button"
      // Every `render` usage in this app points at a Next.js <Link> (an
      // <a>, not a <button>) — Base UI's default nativeButton={true}
      // otherwise warns that native button semantics are being dropped.
